...
u8 QSPI_Init(void)
{
    ...
    QSPI_Handler.Init.FlashSize=25;//===POSITION_VAL(0X2000000)-1;  //SPI FLASH大小，W25Q256大小为32M字节
...
void HAL_QSPI_MspInit(QSPI_HandleTypeDef *hqspi)
{
    ...
    //PF8,9>>PD11 PD12 QSPI_BK1_IO0 QSPI_BK1_IO1
    ...
    //===PF6,7>>PA1 PE2 QSPI_BK1_IO3>>HOLD/RST QSPI_BK1_IO2>>WP
